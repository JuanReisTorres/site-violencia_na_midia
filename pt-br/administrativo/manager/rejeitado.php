...
<html>
    ...
    <head>
        <meta charset="utf-8">
        <link rel="stylesheet" type="text/css" href="../../css/estilo.css?version=0.60">
    ...
    <body>
        ...
        <div class="paginatitulo">
            <span class="pagename"> REJEITADOS </span>
        </div>
                ...
                include("manager.php");
                    if($resultado_rejeitados -> num_rows > 0){
                        while($linha = $resultado_rejeitados -> fetch_assoc()){
                            ...
                            echo "<b>Redes sociais: </b>" . $linha['redessociais']. "<br>";
                            echo "<b>Relato: </b>" . $linha['relato']. "<br>";
                            echo "<b>Data de envio: </b>" . $linha['data_envio']. "<br><br>";
                            echo '<a class="tentardnv2" href="manager.php?aprovar='.$linha['depid'].'">Aprovar</a> <br><br><br>';
                            echo '<a class="tentardnv2" href="manager.php?reprovar='.$linha['depid'].'">Rejeitar</a> <br>';
                            echo "<br> <br>";
                            echo "</div>";
                        }
                    }
